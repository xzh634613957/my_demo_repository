...
if("TRUE" STREQUAL "TRUE")
  set(plumbing_pub_sub_SOURCE_PREFIX /home/xiongzh/demo_ros/demo3_1/src/plumbing_pub_sub)
  set(plumbing_pub_sub_DEVEL_PREFIX /home/xiongzh/demo_ros/demo3_1/devel)
  ...
  set(plumbing_pub_sub_INSTALL_PREFIX /home/xiongzh/demo_ros/demo3_1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plumbing_pub_sub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xiongzh/demo_ros/demo3_1/src/plumbing_pub_sub/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/xiongzh/demo_ros/demo3_1/devel/lib;/home/xiongzh/catkin_ws/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND plumbing_pub_sub_EXPORTED_TARGETS ${${plumbing_pub_sub_dep}_EXPORTED_TARGETS})
endforeach()
